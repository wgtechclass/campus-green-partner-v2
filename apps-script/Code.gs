...
var DEFAULT_ROWS = {
  ...
  Pets: [
    ...
    { petId: "spirit_potato", petName: "阿栗", description: "擅長垃圾分類與資源回收挑戰。", trait: "垃圾分類、資源回收", imageStage1: "assets/spirits/potato.png", imageStage2: "assets/spirits/potato.png", imageStage3: "assets/spirits/potato.png", imageStage4: "assets/spirits/potato.png", active: true, spiritRole: "回收守衛", primaryEnergy: "cleanse", secondaryEnergy: "wisdom", colorTheme: "brown", icon: "栗" }
  ],
  Missions: [
